    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                <ul class="thumbnails mainimage">
                    <li>
                        <a rel="position: 'inside' , showTitle: false, adjustX:-4, adjustY:-4"
                           class="thumbnail cloud-zoom" href="{{ asset('themes/img/product1big.jpg') }}">
                            <img src="{{ asset('themes/img/product1big.jpg') }}" alt="" title="">
                        </a>
                    </li>
                    <li>
                        <a rel="position: 'inside' , showTitle: false, adjustX:-4, adjustY:-4"
                           class="thumbnail cloud-zoom" href="{{ asset('themes/img/product2big.jpg') }}">
                            <img src="{{ asset('themes/img/product2big.jpg') }}" alt="" title="">
                        </a>
                    </li>
                    <li>
                        <a rel="position: 'inside' , showTitle: false, adjustX:-4, adjustY:-4"
                ...
                <ul class="thumbnails mainimage">
                    <li class="producthtumb">
                        <a class="thumbnail">
                            <img src="{{ asset('themes/img/product1.jpg') }}" alt="" title="">
                        </a>
                    </li>
                    <li class="producthtumb">
                        <a class="thumbnail">
                            <img src="{{ asset('themes/img/product2.jpg') }}" alt="" title="">
                        </a>
                    </li>
                    <li class="producthtumb">
                        <a class="thumbnail">
            ...
            <div class="col-lg-7">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="productname"><span class="bgnone">My First Simle One Ecommerce template</span>
                        </h1>
...
<!--  Related Products-->
@include('elements.related_products')
<!-- Popular Brands-->
@include('elements.popular_brands')
@endsection